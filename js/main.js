...
const getData = async () => {
    ...
    let response = await axios.get(`https://ergast.com/api/f1/${year}/${round}/driverStandings.json`) // This is for getting a different endpoint
...
const create_driver = (position, name, lastName, nationality, sponser, points) => {
...
<h4 class="new-item sponser col-12 col-md-2">${sponser}</h4>
